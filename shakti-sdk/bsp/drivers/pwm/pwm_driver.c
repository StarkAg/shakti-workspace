...
int set_pwm_period_register(int module_number, int value)
{
	...
	period_value = (volatile short *) (uintptr_t)(PWM_BASE_ADDRESS + module_number*PWM_MODULE_OFFSET + PERIOD_REGISTER);
	*period_value = value;
...
int set_pwm_duty_register(int module_number, int value)
{
	...
	duty_value = (volatile short *) (uintptr_t)(PWM_BASE_ADDRESS + module_number*PWM_MODULE_OFFSET + DUTY_REGISTER);
	*duty_value = value;
...
int set_pwm_control_register(int module_number, int value)
{
	...
	control_value = (volatile char *) (uintptr_t)(PWM_BASE_ADDRESS + module_number*PWM_MODULE_OFFSET + CONTROL_REGISTER);
	*control_value = value;
...
int set_pwm_clock_register(int module_number, int value)
{
	...
	clock_value = (volatile short *) (uintptr_t)(PWM_BASE_ADDRESS + module_number*PWM_MODULE_OFFSET + CLOCK_REGISTER);
	*clock_value = value;
...
void pwm_use_external_clock(int module_number, bool value)
{
	...
	control_value = (unsigned char *) (uintptr_t)(PWM_BASE_ADDRESS + module_number * PWM_MODULE_OFFSET + CONTROL_REGISTER);
	if(value == 1)
...
void show_register_values(int module_number)
{
	...
	period_value = (volatile unsigned short *) (uintptr_t)(PWM_BASE_ADDRESS + module_number * PWM_MODULE_OFFSET + PERIOD_REGISTER);
	duty_value = (volatile unsigned short *) (uintptr_t)(PWM_BASE_ADDRESS + module_number * PWM_MODULE_OFFSET + DUTY_REGISTER);
	control_value = (volatile unsigned char *) (uintptr_t)(PWM_BASE_ADDRESS + module_number * PWM_MODULE_OFFSET + CONTROL_REGISTER);
	clock_value = (volatile unsigned short *) (uintptr_t)(PWM_BASE_ADDRESS + module_number * PWM_MODULE_OFFSET + CLOCK_REGISTER);
